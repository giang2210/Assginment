package com.example.assginment;
...
import com.example.assginment.adapter.HourAdapter;
import com.example.assginment.model.Wheather;
import com.example.assginment.network.ApiManager;
    ...
    private void getHours() {
        ...
        service.getHour().enqueue(new Callback<List<Wheather>>() {
            ...
            public void onResponse(Call<List<Wheather>> call, Response<List<Wheather>> response) {
                ...
                tvTem.setText(wheather.getTeamperature().getValue().intValue() + "°");
